...
class SlimTest extends \PHPUnit_Framework_TestCase
{
    ...
    const USED_SECRET = 'MeZTe+srVt0c';
    ...
    public function testCrazyHeaderShit()
    {
        ...
        $liveSlimRequest = SlimRequest::createFromEnvironment(Environment::mock(static::LIVE_ENV_DATA));

        $this->assertTrue($verifier->verify($liveSlimRequest, static::USED_SECRET));
    }
}
